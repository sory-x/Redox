...
PODMAN_CONFIG=--env ARCH=$(ARCH) --env BOARD=$(BOARD) --env CONFIG_NAME=$(CONFIG_NAME) --env FILESYSTEM_CONFIG=$(FILESYSTEM_CONFIG) --env PREFIX_BINARY=$(PREFIX_BINARY) \
               ...
               --env REPO_APPSTREAM=$(REPO_APPSTREAM) --env REPO_BINARY=$(REPO_BINARY) --env REPO_BINARY_STRICT=$(REPO_BINARY_STRICT) --env REPO_BINARY_REFRESH=$(REPO_BINARY_REFRESH) --env SORYOS_RELEASE_INDEX_URL=$(SORYOS_RELEASE_INDEX_URL) --env SORYOS_RELEASE_REPOSITORY=$(SORYOS_RELEASE_REPOSITORY) --env SORYOS_RELEASE_STRICT=$(SORYOS_RELEASE_STRICT) --env REPO_NONSTOP=$(REPO_NONSTOP) --env REPO_OFFLINE=$(REPO_OFFLINE) --env TESTBIN=$(TESTBIN) \
